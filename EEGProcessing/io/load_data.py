...
# from EEGProcessing.plot.plot_eeg import plot_gui

from EEGProcessing.plot.sleep import sleep
from EEGProcessing.utils.utils import second2time


class load_gui(QMainWindow, Ui_Load_data):
    def __init__(self, parent=None):
        super(load_gui, self).__init__(parent)
        # self.detail = dialog_detail()
        self.setupUi(self)

        # Fill the dataTimeEdit with current time
    ...
    def get_data_path(self):
        ...
        self.data_path, _ = QFileDialog.getOpenFileName(self, 'Select data file',
                                                        r'E:\workplace\EEGProcessing\EEG script & dataset',
